     ...
     return (
          <div className={styles.wrapper} id={"video"}>
               ...
               <div className={styles.blockText}>
                    <Title type={"h3"} color={"dark"}>Как это работает?</Title>
                    <div className={styles.time}>
                         <Image src={"icon/Time Circle.svg"} alt={"Time"} width={20} height={20}/>
                         <Text type={"reg14"} color={"telegray"}>Продолжительность 2:30 минуты</Text>
                    </div>
                    <Text type={"reg18"} color={"grey"}>Короткий ролик, чтобы ознакомиться как работает решение на платформе Salebot</Text>
               </div>
          </div>
     );
};
