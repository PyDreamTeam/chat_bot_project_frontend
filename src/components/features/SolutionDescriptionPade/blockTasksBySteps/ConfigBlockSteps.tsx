export const CONFIG_BLOCK_STEPS = [
     ...
     },
     {
          ...
          content: "Знакомство с пользователем и запрос имени происходит в чат-боте. Все данные,\n" +
     ...
     },
     {
          ...
          content: "Предлагаем пользователю пройти тестирование для подбора программы обучения.\n" +
     ...
     },
     {
          ...
          content: "После того, как определили уровень знаний, студенту предлагается записаться на бесплатную\n" +
     ...
     },
     {
          ...
          content: "Менеджер дополнительно к новой записи в гугл-таблице получает уведомление в\n" +
     ...
     },
     {
          ...
          content: "На следующий день после пробного урока чат-бот отправляет пользователю сообщение с предложением купить платный курс и оплатить прямо в боте.\n" +
     ...
     },
     {
          ...
          content: "После оплаты студенту высылается первый урок с заданием. Урок размещается на\n" +
            "минилендинге.\n" +
     ...
     },
     {
          ...
          content: "Для перехода к следующему уроку студент должен отправить домашнее задание на\n" +
     ...
     },
     {
          ...
          content: "Чат-бот вносит эту оценку в журнал успеваемости.\n" +
     ...
     },
     {
          ...
          content: "После того, как пройдены все уроки, студент приглашается на экзаменационный\n" +
     ...
     },
     {
          ...
          content: "После сдачи экзамена куратор отправляет кодовое слово боту, вводит ID пользователя и выставляет оценку.\n" +
