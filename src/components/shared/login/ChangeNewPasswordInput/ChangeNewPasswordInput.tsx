     ...
     return(
          <div className={css.blockInput}>
               <label htmlFor="new_password">
                    <Text type="reg18" color="black">Новый пароль</Text>
               </label>
               ...
               <div className={css.groupStateEye}>
                    <Field type={openEye} name="new_password" placeholder="Введите новый пароль" className={errors.new_password && touched.new_password ? `${css.inputError}` : `${css.input}`}/>
