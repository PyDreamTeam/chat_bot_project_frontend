     ...
     return(
          <div className={css.blockInput}>
               ...
               <div className={css.groupStateEye}>
                    <Field type={openEye} name="re_new_password" placeholder="Повторите новый пароль" className={errors.re_new_password && touched.re_new_password ? `${css.inputError}` : `${css.input}`}/>
