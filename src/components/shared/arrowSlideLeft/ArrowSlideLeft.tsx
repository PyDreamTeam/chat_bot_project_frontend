          ...
          <div className={className} onClick={onClick}>
               <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 52 52" fill="none">
                    <g filter="url(#filter0_d_3814_5568)">
                         ...
                         />
                         <path d="M30 25.0366L21.1208 24.9962" stroke="#17181A" stroke-width="1.5" stroke-linecap="round" />
                    </g>
                    <defs>
                         <filter
                         ...
                         >
                              ...
                              <feColorMatrix
                                   ...
                                   result="hardAlpha"
                              />
                              <feMorphology radius="2" operator="dilate" in="SourceAlpha" result="effect1_dropShadow_3814_5568" />
                              <feOffset dx="1" dy="1" />
