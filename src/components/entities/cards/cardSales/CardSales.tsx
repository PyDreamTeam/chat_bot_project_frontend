...
export const config: Advantages[] = [
     {
          ...
          text: <Text type={"reg16"} color={"grey"}>Получение большего количества клиентов</Text>,
     },
     {
          icon: <Image src={"img/Пункты.svg"} alt={"Пункты"} width={24} height={24}/>,
          text: <Text type={"reg16"} color={"grey"}>Привлечение клиентов по сниженной стоимости</Text>,
     },
     {
          icon: <Image src={"img/Пункты.svg"} alt={"Пункты"} width={24} height={24}/>,
          text: <Text type={"reg16"} color={"grey"}>Наглядный контроль отдела продаж</Text>,
     },
     {
          icon: <Image src={"img/Пункты.svg"} alt={"Пункты"} width={24} height={24}/>,
          text: <Text type={"reg16"} color={"grey"}>Высокое качество обслуживанияя</Text>,
     },
          ...
          <div className={styles.wrapper}>
               <div className={styles.blueBlock}>
                    <div className={styles.price}>
                         <Text type={"reg18"} color={"telegray"}>от</Text>
                         <Title type={"h3"} color={"dark"}>9999</Title>
                         <Text type={"reg18"} color={"telegray"}>RUB</Text>
                    </div>
