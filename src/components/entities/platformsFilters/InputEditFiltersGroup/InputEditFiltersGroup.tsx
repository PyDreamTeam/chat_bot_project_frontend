import React, { FC, KeyboardEvent, ChangeEvent, FocusEvent, useState, MutableRefObject, useEffect } from "react";
...
import { useEditPlatformFilterGroupMutation, useGetPlatformFilterGroupsQuery } from "@/src/store/services/platforms";
import Cookies from "js-cookie";

interface PropsInputGroupEdit {
    id: number | undefined;
    placeholder?: string;
...
const InputEditFiltersGroup: FC<PropsInputGroupEdit> = ({
    id,
    placeholder,
    value,
    isShown,
...
export default InputEditFiltersGroup;
