...
import {
    GroupsFilters,
    PropsGroupsFilters,
} from "@/src/components/entities/platforms/addPlatform/filtersForAddPlatform/GroupsFiltrs/GroupsFilters";
...
import {
    ...
    getLinkToSolution,
    linkToPlatform,
} from "@/src/store/reducers/addPlatform/slice";
...
const PublicPlatform = () => {
    ...
    const [platformPublic, { isSuccess: isSuccessPublic }] = usePlatformPublicMutation();
    ...
    const { data } = useGetPlatformQuery(Number(publicId));
    ...
    useEffect(() => {
        setPlatform((prev) => ({ ...prev, links_to_solution: links, turnkey_solutions: links?.length }));
    }, [links]);
        ...
        <WrapperAdminPage>
            <ContainerAdminFunction>
                <div className={css.links}>
                    ...
                    <span className={css.link}>/Публикация платформы</span>
                </div>
                        ...
                        <div className={css.modalContent}>
                            ...
                            <div className={css.groupBtnModalClose}>
                                ...
                                <button
                                    ...
                                    onClick={() => changePlatform({ id, token, platform })}
                                >
                    ...
                    <div className={css.modal}>
                        <div className={css.modalContent}>
                            <Image
                                ...
                                height={24}
                                className={css.imgCloseModal}
                                onClick={handlePublicAddPlatform}
                                style={{ cursor: "pointer" }}
                            />
                            <Image src={"/platforms/publicPlatform.svg"} alt="icon" width={56} height={56} />
                            <Title type="h5" color="dark" className={css.titleModalClose}>
                                Опубликовать платформу?
                            </Title>
                            <div className={css.groupBtnModalClose}>
                                <button className={css.btnCloseModal} onClick={handlePublicAddPlatform}>
                                    <Text type="reg18" color="red">
                                        Отмена
                                    </Text>
                                </button>
                                <button
                                    className={css.btnSaveModal}
                                    onClick={() => platformPublic({ id, token, platform })}
                                >
                                    <Text type="reg18" color="white">
                                        Опубликовать
                                    </Text>
