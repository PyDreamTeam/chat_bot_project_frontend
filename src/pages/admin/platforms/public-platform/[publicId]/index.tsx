        ...
        <WrapperAdminPage>
            <ContainerAdminFunction>
                ...
                }
                {
                    ...
                    <div className={css.modal}>
                        <div className={css.modalContent}>
                            <Image src="/img/close.svg" alt="icon" width={24} height={24} className={css.imgCloseModal} onClick={handlePublicAddPlatform} style={{cursor: "pointer"}}/>
                            <Image src={"/platforms/publicPlatform.svg"} alt="icon" width={56} height={56}/>
                            <Title type="h5" color="dark" className={css.titleModalClose}>Опубликовать платформу?</Title>
                            <div className={css.groupBtnModalClose}>
                                <button className={css.btnCloseModal} onClick={handlePublicAddPlatform}>
                                    <Text type="reg18" color="red">Отмена</Text>
                                </button>
                                <button className={css.btnSaveModal} onClick={() => platformPublic({id, token, platform})}>
                                    <Text type="reg18" color="white">Опубликовать</Text>
                                </button>
                            </div>
                        </div>
                    </div>
