                    ...
                    <Formik
                        ...
                        validationSchema={Yup.object().shape({
                            first_name: Yup.string().trim()
                                ...
                                .matches(/^[a-zA-Zа-яА-ЯёЁ]+(-[a-zA-Zа-яА-ЯёЁ]+)?$/, "Может содержать только буквы и не более одного дефиса, имя не должно заканчиваться на дефис"),
                            last_name: Yup.string().trim()
                                .min(2, "Содержит две или более букв")
                                .max(30, "Не более 30 букв")
                                .matches(/^[a-zA-Zа-яА-ЯёЁ]+(-[a-zA-Zа-яА-ЯёЁ]+)?$/, "Может содержать только буквы и не более одного дефиса, фамилия не должна заканчиваться на дефис"),
                            email: Yup.string()
